        ...
        <form wire:submit.prevent="save">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    ...
                    <textarea wire:model="notes" rows="2" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"></textarea>
                        ...
                        <div class="border rounded-lg p-4 bg-gray-50">
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div class="md:col-span-2">
                                    ...
                                    <select wire:model="items.{{ $index }}.product_id" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model="items.{{ $index }}.quantity" min="1" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
                                ...
                                <div>
                                    ...
                                    <input type="number" step="0.01" wire:model="items.{{ $index }}.price" min="0" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">
            ...
            <div class="flex gap-2">
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold text-lg min-h-[44px]">
                    Record Purchase
                </button>
            </div>
        </form>
